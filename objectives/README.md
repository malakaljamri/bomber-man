...
You will have to follow more or less the same principles of [make-your-game](D:\GTR\Documents\reboot01\make-your-game) project. But we will refresh one of the concepts you will have to respect and deal with:

- [**Performance**](D:\GTR\Documents\reboot01\good-practices-README.md), is one of the most important aspects while developing a game, so let's respect it.\
...
You must not use canvas, neither [Web-GL](https://get.webgl.org/) nor another framework. For this project you will use the framework you did on the [mini-framework](D:\GTR\Documents\reboot01\mini-framework) project.
...
2. Map
   ...
   2. There will be two types of blocks, the ones that can be destroyed (blocks) and the ones that can not (walls).
      1. The walls will always be placed in the same place, while the blocks are meant to be generated randomly on the map. Tip: the optional project [different maps](D:\GTR\Documents\reboot01\make-your-game\objectives\different-maps\README.md) can be useful for this part.
